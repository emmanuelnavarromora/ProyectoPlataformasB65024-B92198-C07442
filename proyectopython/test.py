...
if __name__ == '__main__':
    ...
    text_judgment2 = 'Juez: \n' + '''Sara estaba a punto de recibir una enorme
    herencia familiar'''
    ...
    text_code2 = '''Una nota que índica que Sara solicito cambiar la contraseña
    su caja fuerte por algo que no iba a olvidar'''

    text_heredity = '''Sara recibió una carta de que iba a recibir una gran
    ...
    def render_multi_line(text, x, y, fsize):
        ...
        for i, l in enumerate(lines):
            font = pygame.font.SysFont('timesnewroman', fsize)
